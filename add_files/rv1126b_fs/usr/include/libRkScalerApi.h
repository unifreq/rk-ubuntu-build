...
//////////////////////////////////////////////////////////////////////////
//
// Last update 20241217 for v0.4.0
...
#define RKSCALER_MAX_YUV_PLANE_NUM  3   // max plane number is 3 for YUV planar
...
{
    // YUV formats
    SCALER_FMT_YUV420P  = 0, // YUV420P, DRM_FORMAT_YUV420
    SCALER_FMT_YUV422P  = 1, // YUV422P, DRM_FORMAT_YUV422
    SCALER_FMT_YUV440P  = 2, // YUV440P
    SCALER_FMT_YUV444P  = 3, // YUV444P, DRM_FORMAT_YUV444
    SCALER_FMT_YUV420SP = 4, // YUV420SP, DRM_FORMAT_NV12
    SCALER_FMT_YUV422SP = 5, // YUV422SP, DRM_FORMAT_NV16
    SCALER_FMT_YUV440SP = 6, // YUV440SP
    SCALER_FMT_YUV444SP = 7, // YUV444SP, DRM_FORMAT_NV24
    SCALER_FMT_YUV400   = 8, // YUV400, DRM_FORMAT_R8
    SCALER_FMT_YUV_MAX,      // Donot use this!

    // RGB formats
    SCALER_FMT_ARGB8888 = 1000, // DRM_FORMAT_ARGB8888, [31:0]-A:R:G:B-8:8:8:8
    SCALER_FMT_ABGR8888 = 1001, // DRM_FORMAT_ABGR8888, [31:0]-A:B:G:R-8:8:8:8
    SCALER_FMT_RGB_MAX,         // Donot use this!
    SCALER_FMT_MAX
};
